...
// SECURITY FIX: Disable reset by default for production & public repositories.
// Change $allowReset to true ONLY during local debugging.
$allowReset = false; 
$forceReset = $allowReset && isset($_GET['reset']) && $_GET['reset'] == '1';
...
try {
    ...
    if (!$dbExists || $forceReset) {
        ...
        $pdo->exec("CREATE TABLE IF NOT EXISTS listings (
            ...
            name TEXT,
            name_ta TEXT,
            type TEXT, -- tractor, harvester, sprayer, plough, transport, earthmover, other
